...
model = PPO("MlpPolicy", env, learning_rate= 0.000827, gamma = 0.96979, gae_lambda= 0.92680, ent_coef= 0.0000199, verbose=1, tensorboard_log=f"runs/ppo_enduro")
...
# Save the agent
model.save("atari_ppo_enduro")
vec_env = model.get_env()

del model # remove to demonstrate saving and loading

# Load the agent
model = PPO.load("atari_ppo_enduro")
